...
const Hero2 = () => {
  ...
  return (
    <section className="hero relative h-[790px] lg:h-[700px] col:h-[450px] overflow-hidden z-20">
      <div className="hero-slider">
        ...
        >
          <SwiperSlide>
            <div
              className="slide-inner slide-bg-image h-[790px] lg:h-[700px] col:h-[450px]"
              style={{
                backgroundImage: `url(${"/images/slider/slide-1.png"})`,
              }}
            >
              <div
          ...
          <SwiperSlide>
            <div
              className="slide-inner slide-bg-image h-[790px] lg:h-[700px] col:h-[450px]"
              style={{
                backgroundImage: `url(${"/images/slider/slide-2.png"})`,
              }}
            >
              <div
                className="slide  relative h-full bg-cover bg-no-repeat z-10  after:absolute after:content-[''] 
