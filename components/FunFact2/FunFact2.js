...
const FunFact2 = (props) => {
  ...
  return (
    <section
      className="relative  bg-center bg-cover bg-no-repeat bg-fixed pt-[100px] pb-[95px] z-10 
          ...
          <div className="col-span-12 md:col-span-12 sm:col-span-12">
            <div className="counter-grids relative overflow-hidden">
              {funFact.map((funfact, fitem) => (
                <div
                  className="w-[24.33%] md:w-[48.33%] float-left pt-[40px] pb-[40px] mr-[5px] bg-[#c0b59633] mb-[5px] text-center sm:flex-none col:w-full"
                  key={fitem}
                >
                  <div>
                  ...
                  <p className=" text-[18px] fonts-normal pt-[10px] text-[#c0b596]">
                    {funfact.subTitle}
                  </p>
                </div>
              ))}
