...
import Logo from "../../public/images/logo1/logo.png";
      ...
      <div className="bg-[#272c3f] pt-[5px]">
        <div className="wraper relative before:absolute before:w-full before:h-[1px] before:bg-[rgba(255,255,255,.07)] before:bottom-0 before:left-0 before:content-['']">
          <div className="grid grid-cols-12">
            ...
            <div className="col-span-2 md:col-span-12 flex gap-3 items-center justify-end">
              ...
              <div className="text-right md:text-center md:mb-[15px]">
                {session ? (
                  <Link href={"/profile"}>
                    <button className="theme-btn md:text-[14px] md:py-[8px] md:px-[22px] whitespace-nowrap">
                      Profile
                    </button>
                  </Link>
                ) : (
        ...
        <div className="wraper">
          <div className="flex items-center justify-between ">
            ...
            <ul className="md:hidden ml-auto">
              ...
              <li className="relative inline-block group">
                <ul className="absolute w-[240px]  left-0 top-[110%] p-[20px] z-[111]  bg-[#fff] shadow-[#3e419f17]  transition-all  opacity-0 invisible group-hover:opacity-100  group-hover:top-full group-hover:visible"></ul>
              </li>
              <li className="relative inline-block group">
                ...
                <ul className="absolute w-[240px]  left-0 top-[110%] p-[20px] z-[111]  bg-[#fff] shadow-[#3e419f17]  transition-all  opacity-0 invisible group-hover:opacity-100  group-hover:top-full group-hover:visible">
                  <li>
                    <Link
                      onClick={ClickHandler}
                      href="/blog"
                      className="text-[15px] lg:text-[14px] uppercase inline-block py-[5px] text-[#333] group relative overflow-hidden font-normal transition-all hover:text-[#c0b596] 
                                        "
                    >
                      Blog right sidebar
                    </Link>
              ...
              <li className="relative inline-block group">
                ...
                <ul className="absolute w-[240px]  left-0 top-[110%] p-[20px] z-[111]  bg-[#fff] shadow-[#3e419f17]  transition-all  opacity-0 invisible group-hover:opacity-100  group-hover:top-full group-hover:visible">
                  ...
                  <li>
                    <Link
                      onClick={ClickHandler}
                      href="/attorneys-single/Willam-Stephen"
                      className="text-[15px] lg:text-[14px] inline-block py-[5px] uppercase text-[#333] group relative overflow-hidden font-normal transition-all hover:text-[#c0b596] 
                                        "
                    >
                      Attorney Single
