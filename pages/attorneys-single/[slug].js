          ...
          <div className="grid grid-cols-12 gap-3">
            ...
            <div className="col-span-10 md:col-span-12">
                ...
                <div className="col-span-6 md:col-span-6 sm:col-span-12">
                  <div className="bg-[#f5f5f5] text-center pt-[47px] md:pt-[56px]">
                    <div className="w-[380px] h-[380px] md:w-[350px] md:h-[350px] col:w-[300px] col:h-[300px] mx-auto mb-[47px] md:mb-[56px]">
                      <Image
                        className="rounded-full border-[15px] border-[#c0b596]"
                ...
                <div className="col-span-6 md:col-span-6 sm:col-span-12">
                  <div className="bg-[#f5f5f5] sm:mt-[30px]">
                    ...
                    <div className="p-[30px] pb-0">
                      <ul>
                        <li className="text-[16px] text-[#666]">
                        ...
                        {/* <li className="text-[16px] text-[#666] mt-[15px] md:mt-[12px]">
                          ...
                          Family Lawyer, Criminal Defence, Personal Injury
                        </li> */}
                        <li className="text-[16px] text-[#666] mt-[15px] md:mt-[12px]">
                          <span className="text-[#666] text-[20px] font-bold font-heading-font">
                            Experience:{" "}
              ...
              <div className="my-[50px]">
                ...
                <p className="text-[#666] text-[16px] leading-[28px]">
              ...
              <div className="mt-[40px]">
                ...
                <div className="grid grid-cols-12 gap-3">
                  {Cases.slice(0, 3).map((cases, i) => (
                    <div
                      className="col-span-4 md:col-span-6 col:col-span-12"
                      key={i}
                    >
